...
CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -ldflags "-s -w" -o ./releases/${category_name}_M1

echo "正在编译: $category_name-Mac-Intel..."
CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -ldflags "-s -w" -o ./releases/${category_name}_Intel
